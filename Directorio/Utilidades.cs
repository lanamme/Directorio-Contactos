...
namespace Directorio
{
    internal static class Utilidades
    {
        ...
        public static string archivos_path = path + "\\" + "archivos";
        ...
        public static bool GuardarFotografias(System.Web.UI.WebControls.FileUpload file, String nombreArchivo)
        {
            try
            {
                // Path del directorio donde vamos a guardar el archivo
                String pathToCheck = fotos_path;
            ...
            {
                ErrorBitacora(exception.Message, "No es posible guardar la fotografía");
                return false;
            }
        }

        public static bool GuardarDocumentos(HttpPostedFile file, String nombreArchivo)
        {
            try
            {
                // Path del directorio donde vamos a guardar el archivo
                String pathToCheck = archivos_path;
            ...
            {
                ErrorBitacora(exception.Message, "No es posible guardar el documento");
                return false;
            }
        }
        ...
        //public static Boolean enviarCorreo(Dictionary<String, String> informacionCorreo)
        {
            ...
            cliente.Credentials = new System.Net.NetworkCredential("uti.lanamme@ucr.ac.cr", "@4t1.4pp5!");
        ...
        public static void Toastr(Page page, String tipo, String texto)
        {
            ScriptManager.RegisterStartupScript(page, page.GetType(), "Pop", "toastr." + tipo + "('" + texto + "');", true);
        }
